...
export default function SBIDashboard() {
    ...
    const filteredAccounts = accounts.filter((acc) => {
        const matchType = filterType === "all" || acc.name.toLowerCase().includes(filterType.toLowerCase());
        ...
        <div>
            ...
            <div className="dashboard-container">
                ...
                <div className="filter-bar">
                    <input type="text" placeholder="Search account type..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
